...
//    @Secured({"ROLE_ADMIN", "ROLE_USER"})
    @ApiOperation(value = "Bắt đầu chấm công")
...
//    @Secured({"ROLE_ADMIN", "ROLE_USER"})
    @ApiOperation(value = "Chấm công lúc về")
...
//    @Secured({"ROLE_ADMIN", "ROLE_USER"})
    ...
    //    @Secured({"ROLE_ADMIN", "ROLE_USER"})
    @ApiOperation(value = "Tìm chấm công theo staff id", notes = "")
    ...
    @ApiOperation(value = "Lấy tất cả chấm công của staff", notes = "")
    ...
    @ApiOperation(value = "Thêm số giờ làm thêm staff", notes = "")
    ...
    @ApiOperation(value = "Thêm số giờ staff về sớm", notes = "")
